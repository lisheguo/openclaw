...
export const en: TranslationMap = {
  ...
  secretsStore: {
    intro:
      "Manage team-scoped values used by store SecretRefs. Secret values are write-only after saving; environment values stay visible to operators.",
    teamTitle: "Team secrets",
    teamDescription: "Shared secrets and environment variables stored by this Gateway.",
    name: "Name",
    value: "Value",
    lastUpdated: "Last updated",
    updatedBy: "{time} by {name}",
    actions: "Actions",
    actionsFor: "Actions for {name}",
    add: "Add",
    edit: "Edit",
    bulkAdd: "Bulk Add",
    addTitle: "Add team value",
    editTitle: "Edit team value",
    secret: "Secret",
    secretHint: "Secret values are hidden after saving. Env var values stay visible here.",
    replaceHint: "Enter a replacement value. The saved secret cannot be revealed.",
    replacementRequired: "Enter a replacement value for this secret.",
    bulkTitle: "Bulk Add",
    bulkHint: "Paste NAME=VALUE assignments. Quoted values may span multiple lines.",
    bulkValues: "Assignments",
    bulkPlaceholder: "SERVICE_URL=https://service.example\nSERVICE_API_KEY=...",
    autoDetect: "Auto-detect secrets",
    autoDetectHint: "Credential-like names are saved as secrets; other names stay visible.",
    secretCount: "{count} secrets detected",
    entryCount: "{count} entries",
    bulkSave: "Save entries",
    empty: "No team secrets yet",
    emptyHint: "Add credentials or environment values, then reference them from configuration.",
    readDocs: "Read the secrets documentation",
    unavailable:
      "This Gateway does not advertise team secret-store access, or your connection lacks operator.admin access.",
    invalidName: "Use an uppercase environment-style name such as SERVICE_API_KEY.",
    invalidNames: "These names are invalid: {names}",
    noBulkEntries: "Paste at least one NAME=VALUE assignment.",
    valueTooLarge: "Value exceeds the 64 KiB UTF-8 limit.",
    bulkValueTooLarge: "{name} exceeds the 64 KiB UTF-8 limit.",
    saved: "Saved {name}.",
    savedWithWarnings: "Saved {name}; runtime refresh reported {count} warnings.",
    bulkSaved: "Saved {count} entries.",
    bulkSavedWithWarnings: "Saved {count} entries; runtime refresh reported {warnings} warnings.",
    bulkPartialFailure: "Saved {saved} of {total} entries before the import stopped: {error}",
    deleteTitle: "Delete team value?",
    deleteConfirm: "Delete {name}? Config references to this name will stop resolving.",

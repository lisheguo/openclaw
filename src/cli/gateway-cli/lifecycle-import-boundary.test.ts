...
describe("gateway lifecycle hub import boundaries", () => {
  it("re-exports primed symbols from their defining modules instead of facades", () => {
    ...
    expect(hub).toContain('from "../../agents/main-session-recovery/main-session-restart-recovery-marking.js"');
    expect(hub).not.toContain('from "../../agents/main-session-recovery/main-session-restart-recovery.js"');
  });

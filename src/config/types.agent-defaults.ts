...
export type AgentCompactionConfig = {
  ...
  notifyUser?: boolean;
  /**
   * Legacy fallback for Responses providers with a configured input-item limit.
   * Prefer model/provider Responses capabilities so unaffected models stay disabled.
   */
